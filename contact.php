...
try {
    ...
    $mail->Host       = 'aashif549@rku.ac.in';                     //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'aashif549@rku.ac.in';                     //SMTP username
    $mail->Password   = 'xwgo bqiv ofke thbo';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
    //Recipients
    $mail->setFrom('aashif549@rku.ac.in', 'spiHungry');
    $mail->addAddress('aliashif5698012@gamil.com', 'ali');     //Add a recipient
